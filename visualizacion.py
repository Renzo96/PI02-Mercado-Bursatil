...
# KPI 3: Volumen promedio de operaciones
avg_volume = cvx["Volume"].mean()
st.subheader(f":chart_with_downwards_trend: Volumen promedio de operaciones:")
st.write(f"{avg_volume:.2f}")

# KPI 4: Volatilidad de la acción de CVX en comparación con otras empresas del sector petrolero
...
# Mostrar el KPI en Streamlit
st.subheader(":fire: Volatilidad de la acción de CVX en comparación con otras empresas del sector petrolero :fire:")
st.write(f"Desviación estándar del precio de cierre ajustado de CVX: {std_cvx:.2f}")
st.write(f"Desviación estándar del precio de cierre ajustado de BKR: {std_BKR:.2f}")
st.write(f"Desviación estándar del precio de cierre ajustado de HAL: {std_HAL:.2f}")
st.write(f"Desviación estándar del precio de cierre ajustado de SLB: {std_SLB:.2f}")
st.write(f"Desviación estándar del precio de cierre ajustado de CTRA: {std_CTRA:.2f}")
